    ...
    render() 
    {
        ...
        return (
            <div className="loginComponent">
                <section className="vh-101" style={{ backgroundColor: '#FFCCCB' }}>
                                            ...
                                            <div className="card-body p-4 p-lg-3 text-black">
                                                <form>
                                                    ...
                                                    <div className="d-flex align-items-center mb-3 pb-1">
                                                        ...
                                                        <span className="h1 fw-bold mb-0"><img class ="center"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRR_i_hpyyHrZKEpZO8cOdFp3zDxHR3C319FNBWP_Y&s"  style={{paddingLeft:"150px" , height:"180px"}} alt="Atlantis Logo"/></span>
                                                    </div>
