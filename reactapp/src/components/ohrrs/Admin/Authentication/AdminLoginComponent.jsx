    ...
    render() 
    {
        return (
            <div className="adminLoginComponent">
                <section className="vh-100" style={{ backgroundColor: "#FFCCCB" }}>
                                ...
                                <div className="card" style={{ borderRadius: '1rem' }}>
                                    <div className="row g-0">
                                        <div className="col-md-6 col-lg-5 d-none d-md-block">
                                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRR_i_hpyyHrZKEpZO8cOdFp3zDxHR3C319FNBWP_Y&s" alt="Admin Logo" className="img-fluid" style={{paddingTop:"80px" , height:"300px", width:"200px", borderRadius: '1rem 0 0 1rem' }} />
                                        </div>
